...
class BookingClient:
    ...
    def update_booking(self, booking_id: int, headers: dict, data: dict) -> requests.Response:
        return requests.put(url=f"{self.base_url}/booking/{booking_id}", headers=headers, json=data)