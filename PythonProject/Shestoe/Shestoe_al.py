...
# class BasePage:
#     def __init__(self):
#         self.page_text = "Зима. Холодно. Снег."
#
#     def open(self, url):
...
# btn = Button(100, 200, "OK")
# print(btn.x, btn.y, btn.label)  # 100 200 OK|
# НАСЛЕДОВАНИЕ ≠ АВТОМАТИЧЕСКИЙ ВЫЗОВ __init__ РОДИТЕЛЯ
# Если ты переопределил __init__ в дочернем классе — родительский __init__ НЕ ВЫЗЫВАЕТСЯ САМ.
# ЕСЛИ РОДИТЕЛЬ ИМЕЕТ __init__
# И ТЫ ПЕРЕОПРЕДЕЛЯЕШЬ __init__ В ДОЧЕРНЕМ
# ТЫ ОБЯЗАН ВЫЗВАТЬ super().__init__()
# 8. Создай классы:
